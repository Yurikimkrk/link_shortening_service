        ...
        <div className="card blue darken-1">
          <div className="card-content white-text">
            ...
            <div className="input-field">
              <input placeholder="Введите e-mail" id="email" type="text"
                     name='email' className='yellow-input'
                     onChange={changeHandler} value={form.email}/>
                <label htmlFor="email">Email</label>
            </div>
            <div className="input-field">
              <input placeholder="Введите пароль" id="password" type="password"
                     name='password' className='yellow-input'
                     onChange={changeHandler} value={form.password}/>
                <label htmlFor="password">Пароль</label>
            </div>
          </div>
          <div className="card-action">
            <button className='btn yellow darken-4' style={{marginRight: 50}}
